...
```
In case of errors, you may go back to the [Source chapter](/basic_pipeline/03.0_Source.md) or take a look how [Source](https://github.com/membraneframework/membrane_getting_started_tutorial/blob/template/end/lib/elements/Source.ex) and [formats](https://github.com/membraneframework/membrane_getting_started_tutorial/tree/template/end/lib/formats) should look like.
