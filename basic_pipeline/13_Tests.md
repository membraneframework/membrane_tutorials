...
On the `template/end` branch of [our repository](https://github.com/membraneframework/membrane_getting_started_tutorial), in the `tests/` directory, you will find tests for other elements of the pipeline. Feel free to take inspiration from them while writing your own elements!