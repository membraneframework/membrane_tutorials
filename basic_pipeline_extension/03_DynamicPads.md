...
If you combine the approach taken in the chapter about [Bin](1) you can simplify this solution by reducing the size of the link defitions inside the pipeline.
